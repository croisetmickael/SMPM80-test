            ...
            {loading ? (
              ...
              <div className="agents-grid">
                {filteredAgents.map((agent, index) => (
                  ...
                  >
                    <span className="agent-name">{agent.nom} {agent.prenom}</span>
                  </button>
                ))}
              </div>
            ) : (
        ...
        {activeTab === 'numbers' && (
          <>
            <div className="search-box">
              <input
                type="text"
                placeholder="Rechercher par numero d'equipement..."
                value={searchNumber}
            ...
            {inverseResults.length > 0 ? (
              <div className="inverse-results">
                {inverseResults.map((result, index) => (
                  <div key={index} className="inverse-card">
                    ...
                    <div className="inverse-card-body">
                      ...
                      <div className="inverse-row">
                        <span className="inverse-label">Marque:</span>
              ...
              <div className="no-results">
                {searchNumber.trim() ? 'Aucun equipement trouve' : 'Entrez un numero a rechercher'}
              </div>
            )}
          </>
        )}
